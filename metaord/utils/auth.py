...
from metaord.models import Order, Operator
...
class Permissions:
    ...
    def change_order_status():
        perm = Permission.objects.get(codename='change_order_status')
        if perm is not None:
            return perm
        else:
            content_type = ContentType.objects.get_for_model(Order)
            return Permission.objects.create(codename='change_order_status', # mb ADD metaord
